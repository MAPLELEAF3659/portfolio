export const projectItemsFeatured: Array<ProjectPreviewItem> = [
    {
        title: "Empowering Interactive Fitness Game",
        desc: "本研究提出一項「賦能式」人工智慧，結合動態感測韌體裝置增強健身遊戲的多元與挑戰性、降低重複動作無趣感，提升玩家參與度達 16%",
        special: "IEEE ICCE-TW 2023",
        tags: ["AI", "健身遊戲", "ESP8266", "玩家參與度"],
        ...
        desc: "設計基於LDM的單字卡生成系統，透過CC0數據集、GPT-4提示與SLD機制確保版權合法與語意相關，並由實驗證實可為教育領域安全生成適當內容",
        ...
        title: "雙軸穩定器",
        desc: "RPi 4+MPU6050+SG90手持穩定器，以FIFO Buffer降低讀取延遲60%(test with PMU)",
        ...
        title: "ML-Display",
        desc: "ESP32+FreeRTOS+Wi-Fi即時資訊副螢幕，利用雙核心task scheduling加速效能約50%",
        tags: ["ESP32", "Wi-Fi", "FreeRTOS"],
        special:"",
        imgUrl: "/images/projects/ml_display/preview.png",
        url: "/projects/ml_display"
    }, {
        title: "山頂的Pachinko",
        desc: "山區互動式垃圾桶+後台管理，減少垃圾亂丟情形並即時清理環境",
        ...
        title: "滴滴蘭",
        desc: "針對蘭花產業的AR監控+水感測器之滴灌水循環系統，可節省水資源約50%",
        ...
        desc: "MTK LinkIt 7697+MPU6050+藍牙無線光劍控制器結合Unity體感砍火鍋料遊戲",
        tags: ["LinkIt7697", "藍牙", "體感"],
        special:"",
        imgUrl: "/images/projects/hotpot_knight/preview.png",
        url: "/projects/hotpot_knight"
    }, {
        title: "The Blinking Bullet",
        desc: "用Quest 2 VR頭盔+Unreal開發 VR 戰地攝影體驗，並提供新聞網站上傳照片",
...
export const projectItemsOther: Array<ProjectPreviewItem> = [
    {
        title: "疫手掌握 NullTac",
