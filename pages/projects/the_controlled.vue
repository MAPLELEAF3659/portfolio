...
<template>
    <div class="project-detail">
        <SectSubHeader title="演控人生 The Controlled" title-alt="2023 放視大賞．PC與主機遊戲組 入圍" />
        <div class="container mx-auto py-8 sm:py-12 min-h-svh">
            <div class="grid grid-cols-6 gap-4 items-center mx-4 lg:mx-32 xl:mx-48">
                <h1 class="col-span-6 text-title text-center">施工中</h1>
                <h1 class="col-span-6 text-title text-center">Under Construction</h1>
            </div>
        </div>
    </div>
</template>
